...
public class Sprite {
	...
	public static Sprite extra_life = new Sprite(DEFAULT_SIZE, 0, 0, new SpriteSheet("res/item/extra_life.jpg",16),16,16);
	...
	public  Sprite movingSprite(Sprite normal, Sprite x1, Sprite x2, int animate, int time) {
